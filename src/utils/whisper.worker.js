...
async function transcribe(audio) {
  ...
  try {
    ...
    console.log("Pipeline initialized:", transcriptionPipeline); // Log to check if the pipeline is initialized
  } catch (err) {
    console.log(err.message);
    return; // Exit the function if there's an error in pipeline initialization
  }
  ...
  if (!transcriptionPipeline) {
    console.log("Pipeline not initialized properly");
    return; // Exit if pipeline is not properly initialized
  }
