...
export default function FileDisplay(props) {
  ...
  return (
    <main className="flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 w-72 sm:w-96 justify-center pb-20 w-fit max-w-full mx-auto">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="specialBtn px-2 py-2 rounder-lg text-purple-400 flex items-center gap-2 font-medium"
        >
          <p>Transcribe</p>
